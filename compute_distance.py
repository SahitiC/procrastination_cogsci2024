"""
module of functions to find average distance between two sets of trajectories;
...
def avg_distance_all_clusters(data, labels, simulated_data):
    """
    data: trajectories from real data
    labels: from data specifying clusters
    simulated data: simulated trajectories from model
    """
